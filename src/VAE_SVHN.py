...
class VAE_SVHN(Module):
    def __init__(self,
        ...
        #Encoder
        self.h_con1 = Conv2d(in_channels = 3, out_channels = 32, kernel_size = 2, stride = 2, bias = False) #31x31z32
        self.h_batch1 = BatchNorm2d(32)
        
        self.h_con2 = Conv2d(in_channels = 32, out_channels = 32, kernel_size = 2, stride = 2, bias = False) #14x14x32
        self.h_batch2 = BatchNorm2d(32)
        
        self.h_con3 = Conv2d(in_channels = 32, out_channels = 64, kernel_size = 2, stride = 2, bias = False) #6x6x64
        self.h_batch3 = BatchNorm2d(64)
        
        self.h_con4 = Conv2d(in_channels = 64, out_channels = 64, kernel_size = 2, stride = 2, bias = False) #2x2x64
        ...
        self.g_tcon1 = ConvTranspose2d(in_channels = 256, out_channels = 64, kernel_size = 2, stride = 2)
        self.g_batch2 = BatchNorm2d(64)
        
        self.g_tcon2 = ConvTranspose2d(in_channels = 64, out_channels = 64, kernel_size = 2, stride = 2)
        self.g_batch3 = BatchNorm2d(64)
        
        self.g_tcon3 = ConvTranspose2d(in_channels = 64, out_channels = 32, kernel_size = 2, stride = 2)
        self.g_batch4 = BatchNorm2d(32)
        
        self.g_tcon4 = ConvTranspose2d(in_channels = 32, out_channels = 32, kernel_size = 2, stride = 2)
        self.g_batch5 = BatchNorm2d(32)
        
        self.g_tcon5 = ConvTranspose2d(in_channels = 32, out_channels = 3, kernel_size = 2, stride = 2)
